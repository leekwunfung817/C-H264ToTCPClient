...
enum SDK_RET_CODE
{
	...
	H264_DVR_EE_DVR_PASSWORD_NOT_VALID2	= -11318,			//�˺����벻��
	...
	H264_DVR_INVALID_CUR_FLASH			= -11812,			//��������֧���豸ʹ�õ�Flash
	//��ʱ
	H264_DVR_NAT_INIT_TIMEOUT           = -12000,			//�Ƶ�¼��ʼ����ʱ��������һ�㳬ʱ���
	H264_DVR_CATCHPIC_TIMEOUT			= -12001,			//ץͼʧ�ܷ��س�ʱ
...
typedef enum _SDK_CONFIG_TYPE
{
	...
	E_SDK_CFG_DIGITAL_ENCODE, 		//����ͨ��������������---��Ӧ�ṹ��SDK_EncodeConfigAll_SIMPLIIFY(�����þ���ͨ����)
	E_SDK_CFG_DIGITAL_ABILITY, 		//����ͨ���ı�������---��Ӧ�ṹ��SDK_DigitDevInfo�������þ���ͨ���ţ�
	...
	E_SDK_OPERATION_SET_LOGO,	    //��Ƶ�ϵ��ӳ��ҵ�LOGO---��Ӧ�ṹ��SDK_SetLogo
	...
	E_SDK_CFG_CAMERA_SPECIAL_NIGHT,			//ҹ���龰����ģʽ--SDK_CameraSpecialNightCtrl
	E_SDK_CFG_LPR_LIGHT_CONTROL,			//����ʶ��׹�ƿ���--SDK_LPRLigthControl
	E_SDK_CFG_LPR_RECOGNIZE_TRIGGERMODE,	//����ʶ�𴥷���ʽ--SDK_LPRRecognizeTriggerMode
	E_SDK_CFG_LPR_TEMP_CAR_CHARGE_RULE,		//��ʱ���շѹ���--SDK_LPRTempCarChargeRule
	E_SDK_OPERATION_LPR_FORCE_RECOGNIZE,	//ǿ�ƿ�ʼʶ����--SDK_LprForceTrigRecognize
	E_SDK_CFG_LPR_DISPLAY,					//����ʶ�� LED��ʾ������--SDK_LprLedSet
	E_SDK_CFG_LPR_BLACK_WHITE_LIST_WORK_MODE,//�����շ�ϵͳ�ڰ���������ģʽ--SDK_LprBlackWhiteListModeAll
	E_SDK_OPERATION_LPR_LED_SHOW,			//��ʾ����ʾ�շѽ��,���೵λ--SDK_LprLedShow
	E_SDK_CFG_LPR_AUTO_CONTRL_GATE,			//�����շ�ϵͳ�����ʱ���շ��Զ�̧������--SDK_LprAutoContrlGate
	E_SDK_LPR_ENTRY_EXIT_EXPORT,			//ͣ���շ�ϵͳ�����¼����--
	E_SDK_CFG_LPR_ENTRY_EXIT,				//�����շ�ϵͳ���볡����--SDK_LprEntryExitSet
	E_SDK_CFG_LPR_PARKING_LOT_INFO,			//�����շ�ϵͳͣ������Ϣ--SDK_LprParkingLotInfo
	E_SDK_CFG_HARDWARE_ABILITY,				//��������
	E_SDK_CFG_URL_LOAD,						//�Ϻ���֪���ο�����ȡ�ϴ�·��--SDK_CustomURLCfg
	E_SDK_CFG_LPR_HTTP_COMMUNICATION,		//����ʶ����ͨ��httpЭ����������--SDK_LprHttpCommunication
	E_SDK_CFG_PIRDETECT,					//PIR ���--SDK_PIRDetectV2Config
	E_SDK_CFG_SERIAL_TRANS,					//����ׯ�ʹ���͸����ȡweb �˵�����--SDK_SerialTransConfig
	E_SDK_CFG_CAMERA_SET_AWB,   			//����֪���ư�ƽ��--SDK_AWB_ATTR
	E_SDK_CFG_ControlPTZ,					//������̨
	E_SDK_OPERATION_SET_SENSOR_ABILITY,		//���úϷ�ģ��sensor�ȼ���Ϣ
	E_SDK_OPERATION_GET_SENSOR_ABILITY,		//��ȡ�Ϸ�ģ��sensor�ȼ���Ϣ
	E_SDK_OPERATION_SWITCH_WIFI_MODE,		//�л�APģʽ--SDK_SWITCH_WIFI_MODE
	E_SDK_DEVICE_INFO_LPR_VERSION,			//����ʶ��汾��Ϣ--SDK_LPR_VERSION
	E_SDK_CFG_HUMAN_DETECTION,				//���μ��--SDK_HumanDectionCfgAll
	E_SDK_CFG_SET_RTC_TIME,					//����RTCʱ��У��--SDK_SetRtcTime
	E_SDK_ABILITY_VENC_MAX_FPS,				//��ȡ16CV300ʵ��֡��--SDK_CaptureVencMaxFps_s
	E_SDK_CFG_KS_FaceDetect,				//��������ʶ������--SDK_FaceKSDetectCfg
	E_SDK_CFG_KS_FaceFTPUpLoad, 			//����FTP�ϴ�ͼƬ����--SDK_FaceKSPicUpLoadType
	E_SDK_CFG_HUMAN_DETECTIONDVR,			//DVR���μ��--SDK_HumanMotionDetectConfigAll
	E_SDK_CFG_AUDIO_FORMAT_TYPE,			//��Ƶ���뷽ʽ--SDK_AudioSupportType
	E_SDK_ABILITY_AUDIO_ENCODE_TYPE,		//֧�ֵ���Ƶ�����ʽ������--SDK_AudioFormatType
	E_SDK_CFG_NETCOMMONEX,					//˫��������--SDK_NetCommonConfigEx
	E_SDK_CFG_NET_MIDDAS,					//��Ⱥ������DAS����--SDK_DASMidSerInfo
	E_SDK_OPERATION_NEW_UPGRADE_VERSION_DVR,//DVR��������IPC�豸��ȡ�汾��Ϣ--H264_DVR_GetUpgradeVersionV2
	E_SDK_OPERATION_NEW_UPGRADE_VERSION_DVR_LOCAL,	//DVR��������IPC�豸��ȡ�汾��Ϣ--H264_DVR_GetUpgradeVersionV2
	E_SDK_CFG_DIGITAL_HUMAN_ABILITY,		//��ȡ���μ��������--SDK_HumanAbilityAll
	E_SDK_CONFIG_MOTION_IPC,				//IPC�ƶ��������--SDK_MOTIONCONFIG_ALL
	E_SDK_GET_INTELL_ABILITY,				//��ȡ����--SDK_AnalyzeAbilityV2
	E_SDK_CFG_VIDEO_ANALYZE_PUB,			//SDK_PgsIntellInfo��typeΪ0;���ܷ���ʹ�����㷨��������--SDK_AnalyzePub(���ö�Ӧ���ǻ�ȡ����ͨ����			
	E_SDK_CFG_VIDEO_ANALYZE_PEA,			//SDK_PgsIntellInfo��typeΪ1;���ܷ���PEA�㷨����--SDK_tagPEA_RULE_S�����ö�Ӧ���ǻ�ȡ����ͨ����
	E_SDK_CFG_VIDEO_ANALYZE_OSC,			//SDK_PgsIntellInfo��typeΪ2;���ܷ���OSC�㷨����--SDK_CONFIG_OSC_RULE�����ö�Ӧ���ǻ�ȡ����ͨ����
	E_SDK_CFG_VIDEO_ANALYZE_AVD,			//SDK_PgsIntellInfo��typeΪ3;���ܷ���AVD�㷨����--SDK_AVD_RULE_S�����ö�Ӧ���ǻ�ȡ����ͨ����
	E_SDK_CFG_VIDEO_ANALYZE_PUB_ALL,		//���ܷ���ʹ�����㷨��������--SDK_AnalyzePub��������������ͨ����
	E_SDK_CFG_VIDEO_ANALYZE_PEA_ALL,		//���ܷ���PEA�㷨����--SDK_tagPEA_RULE_S��������������ͨ����
	E_SDK_CFG_VIDEO_ANALYZE_OSC_ALL,		//���ܷ���OSC�㷨����--SDK_CONFIG_OSC_RULE��������������ͨ����
	E_SDK_CFG_VIDEO_ANALYZE_AVD_ALL,		//���ܷ���AVD�㷨����--SDK_AVD_RULE_S��������������ͨ����
	E_SDK_CFG_ENCODE_SmartH264V2,			//����264��������--SDK_SmartH264AllV2
	E_SDK_ABILITY_ENCODE_264,				//h264����--SDK_SmartH264Ability
	E_SDK_CFG_ENCODE_H264ABILITY,			//����264��������--SDK_SmartH264Ability
	E_SDK_CFG_PARKING_LOT_DETECT_PARAM, 	//ͣ��λ������--SDK_PgsDetectAll
	E_SDK_GET_PgsTargetInfoAll,				//��ȡȫ����λ״̬��Ϣ--SDK_PgsTargetInfoAll
	E_SDK_CUSTOM_INFO,						//�û��Զ�������--SDK_PgsCustomInfo
	E_SDK_CFG_PGS_LEAD_SCREEN,				//��λ����������������--SDK_PgsNccu
	E_SDK_CFG_PGS_LIGHT_CTRL,				//��λ����ϵͳָʾ�ƿ�������--SDK_PgsLightCtrlAll
	E_SDK_GET_PGSACTIVATIONCODE,			//��ȡ����--SDK_PgsActivationCode
	E_SDK_CFG_CHN_DA_MODE_STATE,			//��ģ�л�����ģʽ����--SDK_ChnDAModeState
	E_SDK_ABILITY_CHN_DA_MODE,				//����ģʽ֧�ֵ��Զ���--SDK_CustomModeAbiltyAll
	E_SDK_CFG_XMGW_INFO,					//����ׯ�Ͷ���--SDK_xm_gw_info
	E_SDK_CFG_XMGW_FLOOR_INFO,    			// ����ׯ�Ͷ���--SDK_xm_gw_floorinfo
	E_SDK_CFG_LIMIT_LOGIN_USERS_NUM,		//������Ƶ�¼�û���--SDK_LimitLoginUsersNum
	E_SDK_OPERATION_NET_COAXIAL_CTRL,		//ie��ͬ�����--SDK_CoaxialCtrlInfo
	E_SDK_CFG_LOG_STORAGE,					//��־�洢-----SDK_LogStorage
	E_SDK_CFG_MULTICHANNEL_ENCODE,			//��ͨ������--SDK_MultiChannelEncode
	E_SDK_ABILITY_MULTICHANNEL_ENCODE,		//��ͨ������--SDK_MultiChannelEncodeAbility
	E_SDK_CFG_SET_FILEDATA,					//���÷��͵��ļ����ݣ�IE�ڲ�ʹ�ã�
	E_SDK_OPERATION_NET_ONLINE_USR,			//ie�˻�ȡ��ǰ��¼�û���--SDK_OnlineUsrList
	E_SDK_CFG_EMAIL_FOR_SEND_RESETCODE,		//�������빦���з�����֤�����������---SDK_NetEmailConfig
	E_SDK_CFG_FACE_DETECTION,				//�������--SDK_FaceMotionDetectConfigAll
	E_SDK_CFG_KS_HTTP_COMMUNICATION,		//����http��������--SDK_KSHttpCommunication
	E_SDK_CFG_PSG_LEAD_SCREEN,				//IPC����������--SDK_LeadScreen
	E_SDK_CFG_INDICATOR_LIGHT,				//IPC��ص�����--SDK_IndicatorLight
	E_SDK_CFG_B_PLAT,						//BЭ��Խ�ƽ̨--SDK_XM_firm_enable_b_interface_t
	E_SDK_CFG_B_SIM_INFO,					//B ƽ̨sim����Ϣ--SDK_XM_firm_sim_info_t
	E_SDK_CFG_B_BATTERY_INFO,				//Bƽ̨������Ϣ--SDK_XM_All_battery_info_t
	E_SDK_FILE_IMPORT,						//�ļ������豸--SDK_ImportFileHead
}SDK_CONFIG_TYPE;
...
enum SDK_EventCodeTypes
{
	...
	SDK_EVENT_CODE_PIRDetect = 38,		//PIR���
	SDK_EVENT_CODE_HumanDetectAlarm,	//���μ�ⱨ��
	SDK_EVENT_CODE_FaceDetectAlarm,		//������ⱨ��
	SDK_EVENT_CODE_FaceRecognitionAlarm,//����ʶ��
	SDK_EVENT_CODE_NR,
};
//! �������õ�����
...
typedef struct SDK_CONFIG_NET_COMMON
{
	...
	//!���������
	int MaxConn;
	//!����Э�� {"TCP","UDP","MCAST","NAT","DaHua","RTSP","IPV6",��}
	int MonMode;
	//!�޶�����ֵ
	int MaxBps;
	//!�������
...
typedef struct SDK_CONFIG_NET_COMMON_V2
{
	...
	char Version[NET_MAX_INFO_LEN];         //�汾��Ϣ�����Ƶ��豸���ݣ�һ���豸û�У�
	SDK_SYSTEM_TIME BuildDate;  			//�汾���ڣ����Ƶ��豸���ݣ�һ���豸û�У�
...
enum SDK_EncodeFunctionTypes
{
	...
	SDK_ENCODE_FUNCTION_TYPE_SMARTH264V2,		//�µ�H264+/H264++
	SDK_ENCODE_FUNCTION_TYPE_CUSTOM_CHN_DA_MODE,///< �Զ�����ģ�л�����
	SDK_ENCODE_FUNCTION_TYPE_SMARTENCODE_DIGITAL,///Smart��������ͨ��
	SDK_ENCODE_FUNCTION_TYPE_MULTICHANNEL,		///��ͨ������
...
enum SDK_AlarmFucntionTypes
{
	...
	SDK_ALARM_FUNCTION_TYPE_PIR_DETECT,			///< PIR ���
	SDK_ALARM_FUNCTION_TYPE_HUMAN_DETECTION,	//���μ��
	SDK_ALARM_FUNCTION_TYPE_HUMAN_DETECTIONDVR,	//DVR���μ��
	SDK_ALARM_FUNCTION_TYPE_NVR_HUMAN_DETECTION,//���μ��NVR
	SDK_ALARM_FUNCTION_TYPE_NEWVIDEOANALYZEDIGIT,
	SDK_ALARM_FUNCTION_TYPE_NVR_HUMAN_DETECTION_NEW,///���μ�⣨NVR�����棩
	SDK_ALARM_FUNCTION_TYPE_IPC_PEA_IN_HUMAN_PED,	//�����ܽ���߼������μ��(IPC)
	SDK_ALARM_FUNCTION_TYPE_FACE_DETECTION,			///�������
	SDK_ALARM_FUNCTION_TYPE_HUMAN_DVR_SUPPORT_LEVEL,///DVR���μ���Ƿ�֧�������
	SDK_ALARM_FUNCTION_TYPE_FUNC_LIGHTCONTRL,		///��������ʾ����
...
enum SDK_NetServerTypes
{
	...
	SDK_NET_SERVER_TYPES_SERIAL_TRANS,		//����ׯ�ʹ���͸����ȡweb �˵�����
	SDK_NET_SERVER_TYPES_DUAL_ETHERNET,		//֧��˫����
	SDK_NET_SERVER_TYPES_MidDAS,			//DAS��Ⱥ���������ķ���������
	SDK_NET_SERVER_TYPES_EMAIL_TLS,			//����֧��TLS����
	SDK_NET_SERVER_TYPES_GA1400,			//GA1400ƽ̨
...
enum SDK_OtherFunction
{
	...
	SDK_OTHER_SUPPORT_SENSOR_ABILITY_SETTING,//֧�ֺϷ�ģ��֧�ֵ�sensor�ȼ�
	SDK_OTHER_SUPPORT_ALARM_LINK_VOICE,		//֧�ֱ�������������ʾ����
	SDK_OTHER_SUPPORT_ALARM_LINK_LIGHT,		//֧�ֱ��������ƹ���ʾ����
	SDK_OTHER_SUPPORT_SET_RTC_TIME,			//֧��RTCʱ��У��
	SDK_OTHER_SUPPORT_AUDIO_FORMAT,			//֧����Ƶ����
	SDK_OTHER_SOFT_PHOTOSENSITIVE,			//��������
	SDK_OTHER_SUPPORT_CLOUD_UPGRADE_IPC,	//֧��NVRͨ���ƶ˸�IPC����
	SDK_OTHER_SUPPORT_FILE_UPGRADE_IPC,		//֧�ַ����ļ�ͨ��NVR��IPC����
	SDK_OTHER_SUPPORT_PARKING_GUIDE_SYSTEM, //֧�ֳ�λ��������
	SDK_OTHER_SUPPORT_LIMIT_NET_LOGIN_USERS,  //���������½���û���
	SDK_OTHER_SUPPORT_COAXIAL_PARAM_CTRL,	  //ͬ���������
	SDK_OTHER_SUPPORT_SHOW_H265X,			//��ʾH265X����
	SDK_OTHER_SUPPORT_LOG_STORAGE_CTRL,		//��־�洢����
	SDK_OTHER_SUPPORT_ADMIN_CONTACT_INFO,	//֧�����ù���Ա��ϵ��ʽ
	SDK_OTHER_SUPPORT_WARN_WEAK_PWD,		//��ʾ����������
	SDK_OTHER_SUPPORT_STRING_CHANGED_XPOE,	//֧��ͨ��ģʽ��ʾΪXPOE
	SDK_OTHER_SUPPORT_ALARM_VOICE_TIPSTYPE,	//֧�ֱ�����ʾ�������޸�
	SDK_OTHER_SUPPORT_ACROSS_IPCTALK,		//֧��ǰ��IPC�Խ�
	SDK_OTHER_SUPPORT_SET_VOLUME,			//֧��������������
	SDK_OTHER_SUPPORT_FACE_DETECT_V2,		//֧���������
	SDK_OTHER_SUPPORT_FACEKS_HUMAN_DETECT,	//֧�ֿ������μ��
	SDK_OTHER_SUPPORT_FACEKS_HTTP_COMMUNICATION,//����http����
	SDK_OTHER_SUPPORT_FACE_RECOGNITION,			//֧������ʶ�� 
	SDK_OTHER_SUPPORT_CUSTOMIZE_LPRECT,		//�Ƿ�֧��������״�ĳ�λ
	SDK_OTHER_NO_SUPPORT_SAFETY_QUESTION,	//�Ƿ����ذ�ȫ����
	SDK_OTHER_SUPPORT_SYS_REMOTE_CTRL,		//֧��ϵͳԶ�̿���
	SDK_OTHER_SUPPORT_ALARM_VOICE_TIP_INTERVAL,  //֧���豸����������ʾ��ѭ�����ŵĲ��ż��
	SDK_OTHER_SUPPORT_SNAPSHOT_CONFIGV2,	//ץͼ����V2
	SDK_OTHER_SUPPORT_ENCODE_LOCK,			//������������
	SDK_OTHER_HIDE_NORMAL_DAYLIGHTMODE,		//���س����3����ҹģʽѡ��,���޸����ܾ����������ʾ
	SDK_OTHER_SUPPORT_EXT_PLAYBACK,			//֧�ָ������ط�
	SDK_OTHER_SUPPORT_EXPORT_IPC_LOG,			//֧�ֵ���IPC��־(���뵼��IPC���� �Լ� ����IPC��־ ʹ��ͬһ����)
	SDK_OTHER_SUPPORT_SHOW_IPC_PARAM,			//֧����ʾIPC����
	SDK_OTHER_SUPPORT_MULTI_TRANS_DATA,			//֧�ֶ�δ�������(����64k)
	SDK_OTHER_SUPPORT_LOCAL_CUSTOM_ALARMVIDEO,	//֧�ֱ��ض��Զ��屨����
	SDK_OTHER_NR
};
...
typedef struct SDK_EventHandler
{
	...
	int		voiceTipInterval;		// �ڱ����ڼ䱨��������ʾ���ż���0��3600�룬0��ʾ���ظ����š�
	int     voiceType;				// �������bVoice��Ӧ����ʾ������ʾ�����ͣ���ö��IAudioManager::DI_PLAY_TYPE
    bool    bShortMsg;              //���Ͷ���
...
typedef struct SDK_URP_OSC_RULE_PARA_S_V2
{
	...
	int SizeMin;												//��С�ߴ�
	int SizeMax; 												//���ߴ�
	SDK_URP_OSC_SPECL_REGIONS_S_V2 astSpclRgs[NET_MAX_OSC_NUM]; //Ҫ������������
...
typedef struct SDK_CONFIG_OSC_RULE
{
	...
	int iAbandumEnable;		   									//��Ʒ����ʹ��
	SDK_URP_OSC_RULE_PARA_S_V2 stObjAbandumRulePara;			//��Ʒ�������
	int iStolenEnable;			  								//��Ʒ����ʹ��
	SDK_URP_OSC_RULE_PARA_S_V2 stObjStolenRulePara;				//��Ʒ��������
	int iNoParkingEnable;		 								//�Ƿ�ͣ��ʹ��
	SDK_URP_OSC_RULE_PARA_S_V2 stNoParkingRulePara;				//�Ƿ�ͣ������
}SDK_CONFIG_OSC_RULE;
/*===================================================*/
...
{
	int     Valid;									//�Ƿ���Ч
	int     IsDoubleDirection;						//��ʾ�ð����Ƿ�Ϊ˫����ߣ�0����1���ǣ�
	URP_SDK_POINT_S StartPt;						//�߶����
	URP_SDK_POINT_S EndPt;							//�߶��յ�
...
typedef struct SDK_URP_PERIMETER_RULE_PARA_S_V2
{
	int  Mode;													//�ܽ�ģʽ
	int  MinDist;												//��С���ؾ���
	int  BoundaryPtNum;											//�߽����Ŀ
	URP_SDK_POINT_S  BoundaryPts[SDK_URP_MAX_TRIPWIRE_CNT];		//�߽�㼯��	
...
{
	int  MinDist;				//��С���ؾ���
	SDK_URP_TRIPWIRE_S_V2 Lines[SDK_URP_MAX_TRIPWIRE_CNT];		//8��������
...
typedef struct SDK_tagPEA_RULE_S
{
	...
	int iLevel;						   							// ���伶��:�ͼ�(2), �м�(1), �߼�(0)
	int iPerimeterEnable;										// �ܽ����ʹ��
	SDK_URP_PERIMETER_RULE_PARA_S_V2	PerimeterRulePara;		// �ܽ���
	int iTripWireEnable;										// �����߹���ʹ��
	SDK_URP_TRIPWIRE_RULE_PARA_S_V2		TripwireRulePara;		// �����߼��
}SDK_tagPEA_RULE_S;
/*===================================================*/
...
//������������
typedef struct SDK_PresetPointTrack		//Ԥ�õ����
{
	int iWatchPoint;					//������
	int iTrackTimeoutTime;			//���ٳ�ʱʱ��
	int iAllowedInterruptEnable;		//������ʹ��
	char resv[16];					//�����ֽ�
}SDK_PresetPointTrack;

typedef struct  SDK_CruisePresePointParam
{
	char cPresePoint;					//Ԥ�õ�
	char cIntervalTime;				//���Ѳ�����ʱ��
}SDK_CruisePresePointParam;

typedef struct SDK_CruiseTrack			//Ѳ������
{
	int iWatchPoint;					//������
	int iTrackTimeoutTime;				//���ٳ�ʱʱ��
	int iAllowedToInterruptEnable;		//������ʹ��
	int iCruiseLine;					//Ѳ��·��
...
{
	int iShowTrack;						// �Ƿ���ʾ�켣
	int iBallCameraTrackEnable;			//���׷��ʹ��
	int iChooseYype;						//ѡ�����������
	int iTrackSpeed;						//�����ٶ����ͣ���ֵΪ�����TRACK_SPEED_HIGH��ö����
	int iTrackSize;						//����Ŀ���С����ֵΪ�����TTRACK_SIZE_BIG��ö����
	int iChangeRatioLimit;				//�䱶����
	SDK_PresetPointTrack tPresetPointTrack; 	//Ԥ�õ��������
	SDK_CruiseTrack tCruiseTrack;				//Ѳ����������
	char resv[64];						//�����ֽ�
}SDK_BCT_RULE_S;
...
{
	TRACK_SIZE_BIG,				//����Ŀ��
	TRACK_SIZE_MEDIUM,			//�е�Ŀ��
	TRACK_SIZE_SMALL,				//С��Ŀ��
};
...
typedef struct SDK_ANALYZEABILITY
{
	...
	char uIntelBCT[NET_MAX_MSK_SIZE];	//����BCT֧�֣�λ��Ӧͨ��
	UINT uAlgorithmBCT;					//BCT֧�ֵ��㷨����
}SDK_ANALYZEABILITY;

//���ܷ�������
typedef struct SDK_AnalyzeAbilityV2
{
	unsigned int uIntelPEA; //����PEA֧�֣�λ��Ӧͨ��
	unsigned int uAlgorithmPEA;//PEA֧�ֵ��㷨���ͣ��������
	unsigned int uIntelOSC; //����OSC֧�֣�λ��Ӧͨ��
	unsigned int uAlgorithmOSC;//OSC֧�ֵ��㷨����
	unsigned int uIntelAVD; //����AVD֧�֣�λ��Ӧͨ��
	unsigned int uAlgorithmAVD;//AVD֧�ֵ��㷨����
	unsigned int uIntelCPC; //����������֧�֣�λ��Ӧͨ��
	unsigned int uAlgorithmCPC;//CPC֧�ֵ��㷨����
...
{
	bool bEnable;							// PIR ��⿪�� 
	bool bInfraredEnable;					// ����ƿ���
	bool bInfraredRelevanceEnable;			// ����ƹ�������
...
typedef struct H264_DVR_FINDINFO
{
	...
	char sEvent[32];		//�Զ����ļ�����:SDK_File_TypeΪSDK_FILE_CUSTOMʱ��Ҫ���룬����Ϊ��
	char sFileFormat[32];	//�Զ����ļ���ʽ:SDK_File_TypeΪSDK_FILE_CUSTOMʱ��Ҫ���룬����Ϊ��
#ifndef OS_IOS
    H264_DVR_FINDINFO()
    {
        hWnd=0;
...
typedef struct
{
	...
	unsigned int   nEncodeType;         ///���ݸ�ʽ���ͼ�SDK_ENCODE_TYPE
...
typedef struct SDK_CameraAbility
{
	...
	char isSupportIntellDoubleLight;		//�Ƿ�֧������˫��
	char isSupportPreventOverExpo;			//�Ƿ�֧�ַ�����
	char isSupportSetLDC;	//�Ƿ�֧�ֻ���У���������ã���VPSSȥУ��
	short minLDC;			//�����õĻ���У��������Сֵ
	short maxLDC;			//�����õĻ���У���������ֵ
	char reserve[24];		//������������int�͵ĳ�Ա������
}SDK_CameraAbility;
...
typedef struct SDK_ASB_NET_VSP_CONFIG
{
    bool	bCsEnable;								//ʹ�ܱ��
    char	szCsIP[64];								//��������ַ
    unsigned short	sCsPort;						//�������˿�
	unsigned short	sUdpPort;						//���ذ�udp�˿�
...
typedef struct SDK_CameraParamEx
{
	...
	int preventOverExpo;			// ������   0:�ر�   1:����
	int softPhotosensitivecontrol; //�������� 0:�����Զ����� 1:����Զ����� 2:����3:�ر�
	int automaticAdjustment; // �Զ����ڵ��� :  1~5
	int LDCValue; //��ͷ����У��������ȡֵ��Χ�ο�CameraAbility�е�minLDC��maxLDC
	int res[52];	//���� 
}SDK_CameraParamEx;
...
typedef struct SDK_IntelBrasSpecialInfo
{
	...
	char autoSearchNewFirm;				//�Ƿ񿪻��Զ������°汾
	char bIntelbrasProtocol;			//�Ƿ�ʹ��interbras��Э��
	char rev2;
	int searchPort;						//�����˿ں�
	int vvMinPort;						//vv ����С�˿�
	int vvMaxPort;						//vv �����˿�
	short  dyndnsUpdateTime;			//dyndns���»�ȡ������ʱ��,��λ��min
	short  noipUpdateTime;				//no-ip���»�ȡ������ʱ��,��λ��min
	int rev[10];
...
typedef struct SDK_MultiChannelEncodeAbility //�ṹ���д�������������ʹ��memset��ʼ�������ṹ�� sizeof[184 BYTE]
{
	unsigned int Compression;          ///֧�ֵı�������
	unsigned int BitRateControl;
	unsigned int uiMaxEncodePower;      ///< ֧�ֵ��ܱ�������
	unsigned int uiMaxBps;              ///< ֧�ֵ������ʴ�СKbps
	unsigned int uiExImageSize;           ///< ֧�ֵķֱ�������
...
{
	SDK_SENSOR_RESOLUTION_NORMAL = 0,		//Ĭ�ϣ���֧��ͨ��Reslution�б�
...
{
	SDK_SENSOR_DEVICE_Normal = 0,					//Ĭ�ϣ���֧��ͨ��Reslution�б�
	SDK_SENSOR_DEVICE_Plain = 1,					//��ͨ
	SDK_SENSOR_DEVICE_Plain_Color = 2,				//��ͨ ��ɫ
	SDK_SENSOR_DEVICE_WDR = 3,						//���̬
	SDK_SENSOR_DEVICE_Low_Light = 4,				//���ն�
	SDK_SENSOR_DEVICE_Stellar = 5,					//�ǹ�
	SDK_SENSOR_DEVICE_Double_Light = 6,				//˫��
...
typedef struct SDK_FishLensParam
{
	...
	char  pPCMac[16];	 //У���豸ʱʹ�õĵ��Ե�MAC��ַ
	char  resv[8];	
} SDK_FishLensParam;
...
{
	bool bUserCustomMode;		//�Ƿ�ʹ���Զ���ģʽ
	int  ChnTotalNum;			//ͨ����·��
	char  ChnMode[NET_MAX_MSK_SIZE/2]; //ͨ���������룬ģ��ͨ������Ϊ1������ͨ������Ϊ0
};
...
{
	SDK_RESTORE_PWD_VERIFYCODE_SEND_TO_APP = 0,				//���������õ���֤��ֱ�ӷ��͸�ɨ���APP
	SDK_RESTORE_PWD_VERIFYCODE_SEND_TO_ADMIN_ACCOUNT = 1,	//���������õ���֤��ֻ����adminָ����������ֻ�
}SDK_VerifyCodeRestorePwdType;

typedef struct SDK_PwdResetQsPair
{
	int questionIndex;					//������ţ�-1��ʾʹ���Զ�������
	char strAnswer[256];				//��(�Ѽ���)
	char strQustion[256];				//�Զ�������
}SDK_PwdResetQsPair;

typedef struct SDK_PasswordSafety
{
	bool bTipPageHide;					//�Ƿ���������Ϊ��ʱ����ʾҳ��
	int  iVerifyCodeRestorePwdType;		//ͨ����֤����������ķ�ʽ����ö��SDK_VerifyCodeRestorePwdType
	SDK_PwdResetQsPair PwdResetQs[4];	//��ȫ����ʹ�
	char resetMailAddr[64];				//���ڽ��ճ������������  
	char strPhone[64];					//�ֻ���
	char resv[20];
}SDK_PasswordSafety;
...
//��λ״̬��
//E_PGS_SPACE_STATE_FIXED_Y ר�г�λ   ռ��
//E_PGS_SPACE_STATE_FIXED_N ר�г�λ   δռ��
//E_PGS_SPACE_STATE_GENERAL_Y ��ͨ��λ ռ��
//E_PGS_SPACE_STATE_GENERAL_N ��ͨ��λ δռ��
//E_PGS_SPACE_STATE_ILLEGAL_PARKING �Ƿ�ͣ��
//E_PGS_SPACE_STATE_ILLEGAL_LEFT ���󷽳�ռ��
//E_PGS_SPACE_STATE_ILLEGAL_RIGHT ���ҷ���ռ��
...
{
	int iState;				//��λ״̬:�ο�ö�� E_PGS_SPACE_STATE
	char pPlateCode[32];	//���ƺ��룬β�����ַ���������"\0" ,�ַ������ʽΪUtf8,�г�ʱΪ���ƺţ��޳�ʱΪ"�޳�",�г���δ��⵽����ʱ"���Ƴ�"
	char pPlateColor[4];	//������ɫ�������ڰ׵�,"��"����δ֪���ַ���������"\0"���ַ������ʽΪUtf8
	SDK_PgsRect rect;		//�����������Ϣ
}SDK_CarInfo;
...
{
	int iChannel;				//ͨ����
	SDK_CarInfo carInfo[3];		//ÿ��������������λ�����������Ϊ��ǰ�ӽǣ������ң���Ӧ��ϵΪ(carInfo[0]--��)��(carInfo[1]--��)��(carInfo[2]--��)
}SDK_PgsTargetInfo;
/*======================��λ�ϱ���Ϣ==========================*/
...
typedef struct SDK_PLATE_DETECT		//������Ϣ
{
	char acPlateCode[20];	//���ƺ��룬β�����ַ���������"\0" 
	char acPlateColor[4];	//������ɫ�������ڰ׻�"��"����δ֪���ַ���������"\0"
	float acfConfidence;	//���Ŷ�
}SDK_PLATE_DETECT;

typedef struct SDK_InfoKSTailPic
{
	unsigned int track_id;
	int human_face_quality;	/*���Ŷ�*/
	int clusterid[5];		/*��0ֵ������������������μ��ļ������ͬһ�ˣ����IDӦ�����,Ŀǰֻ�õ���0��*/
}SDK_InfoKSTailPic;

typedef struct SDK_FACE_DETECT		//������Ϣ
{
	char sex;//�Ա�
	char age;//����
	char resv[26];
...
typedef struct SDK_LPR_TARGET_INFO	//����ʶ��
{
	SDK_RECT_S stRect;
...
{
	char resultType;			//ʶ����������  0:����  1:����ʶ��  
	char picSubType;			//0:��ͼ  1:Сͼ
	char picFormat;				//0:jpg  1:bmp   2:yuv
	char tagNum;				//Ŀ�����
	unsigned int framID;		//֡ID
#ifdef Psg						//��λ�������
	char timestamp[5];			//ʱ���������ʱ����ֱ�ռһ���ֽ�
	char resv[7];
#else							//���Ӷ�������
	unsigned int tagsec;		//�¼�����ʱ��ʱ����
	unsigned int tagusec;		//�¼�����ʱ��ʱ��΢��
	char channel;				//ͨ����
	char reserved[3];
#endif
}SDK_IA_COMM_RES_S;

typedef struct SDK_IA_LPR_REC_S			//����ʶ��
{
...
typedef struct SDK_IA_Pgs_REC_S			//��λ���
{
	SDK_IA_COMM_RES_S comm;				//��������
	void *pTargetInfo;					// ָ��ṹ��SDK_PgsTargetInfo
}SDK_IA_Pgs_REC_S;
...
typedef struct SDK_PushRetData
{
	...
	char* pPushIAData;			//���͵��������ݣ�����nPushType����Ӧ���͵Ľṹ��
	int nChannel;				//ͨ����
	int nLenSize;				//ͼƬ��С
...
{
	E_LPR_PLATE_TYPE_NULL=0,		//δ֪
	E_LPR_PLATE_TYPE_BLUE,			//��ͨ����
	E_LPR_PLATE_TYPE_BLACK,			//��ͨ����
	E_LPR_PLATE_TYPE_YELLOW,		//��ͨ����
	E_LPR_PLATE_TYPE_YELLOW2,		//˫�����
	E_LPR_PLATE_TYPE_POLICE,		//���쳵��
	E_LPR_PLATE_TYPE_ARMYPOLICE,	//�侯����
	E_LPR_PLATE_TYPE_INDIVIDUALITY,	//���Գ���
	E_LPR_PLATE_TYPE_ARMY,			//�������
	E_LPR_PLATE_TYPE_ARMY2,			//˫�����
	E_LPR_PLATE_TYPE_COACH,			//������
	E_LPR_PLATE_TYPE_NEW_ENERGY,	//����Դ��
	E_LPR_PLATE_TYPE_NR
};
...
{
	E_LPR_CAR_COLOR_BULE,	//��ɫ
	E_LPR_CAR_COLOR_YELLO,	//��ɫ
	E_LPR_CAR_COLOR_WHITE,	//��ɫ
	E_LPR_CAR_COLOR_BLACK,	//��ɫ
	E_LPR_CAR_COLOR_OTHER,	//������ɫ
...
{
	E_LPR_VEHICLE_BROND_UNKNOWN,	//��ʶ��ĳ���
	E_LPR_VEHICLE_BROND_TOYOTA,		//����
	E_LPR_VEHICLE_BROND_VOLKSWAGEN,	//����
	E_LPR_VEHICLE_BROND_HONDA,		//����
	E_LPR_VEHICLE_BROND_PEUGEOT,	//����
	E_LPR_VEHICLE_BROND_HYUNDAI,	//�ִ�
	E_LPR_VEHICLE_BROND_BUICK,		//���
	E_LPR_VEHICLE_BROND_AUDI,		//�µ�
	E_LPR_VEHICLE_BROND_KIA,		//����
	E_LPR_VEHICLE_BROND_JEEP,		//����
	E_LPR_VEHICLE_BROND_TORD,		//����
	E_LPR_VEHICLE_BROND_BENZ,		//����
	E_LPR_VEHICLE_BROND_BMW,		//����
	E_LPR_VEHICLE_BROND_MAZDA,		//���Դ�
	E_LPR_VEHICLE_BROND_SUZUKI,		//��ľ
	E_LPR_VEHICLE_BROND_CITROEN,	//ѩ����
	E_LPR_VEHICLE_BROND_NISSAN,		//��ɣ
	E_LPR_VEHICLE_BROND_MITSUBISHI,	//����
	E_LPR_VEHICLE_BROND_LEXUS,		//�׿���˹
	E_LPR_VEHICLE_BROND_CHEVROLET,	//ѩ����
	E_LPR_VEHICLE_BROND_VOLVO,		//�ֶ���
	E_LPR_VEHICLE_BROND_FIAT,		//������
	E_LPR_VEHICLE_BROND_BYD,		//���ǵ�
	E_LPR_VEHICLE_BROND_CHERY,		//����
};

//����
enum SDK_E_LPR_VEHICLE_SIZE_TYPE
{
	E_LPR_VEHICLE_SIZE_CAR,		//С�γ�
	E_LPR_VEHICLE_SIZE_MINIBUS, //�����
...
typedef struct SDK_PlateDetectCfg
{
	...
	char chPlateType;	//��������--��enum SDK_E_LPR_PALTE_TYPE
	char chVehicleColor;//������ɫ��--enum SDK_E_LPR_CAR_COLOR_TYPE
	char chVehicleSize;	//����--��enum SDK_E_LPR_VEHICLE_SIZE_TYPE
	char reserv;		//����λ
	int chVehicleBrond;	//����--��enum SDK_E_LPR_VEHICLE_BROND_TYPE
	SDK_LprGateSplitLine stGateSplitLine;//��բ�ָ�������
	SDK_RECT_S astLpRect[7];
	int iMaxWidth;
	int iMinWidth;
	int iSceneMode; //����ģʽѡ��0:�����, 1:����
}SDK_PlateDetectCfg;
...
{
	bool bEnable;
	SDK_Point vlocationrect[8];				//�������������������Զ����,��״Ϊ��������ͼ��	
}SDK_FaceKSDetectRoi;
...
{
	int nQuality;						//�������Ŷ�
	SDK_Size tMinFaceSize;					//��С������С
	SDK_FaceKSDetectRoi	fRoi;
	int nBlurThreshold;
	SDK_FaceKSPoseAbsThreshold fFacePose;
	int capture_sen; //ץ������ȣ�ȡֵ��Χ0-100
	int FilterThreshold;//�����,ȡֵ��Χ0-100
}SDK_FaceKSConstraint;

//��ͼ����
typedef struct SDK_FaceKSPushStrategy
{
	char smode[NET_NAME_PASSWORD_LEN];		//������ͼģʽ�Ͷ�ʱ��ͼ"BEST"/"INTERVAL"
	int ninterval;//��ͼʱ����
	int total;//��ͼ����
...
{
	bool	bShowBox;						//�Ƿ���ʾ������ʵʱ����
	bool	bShowFaceInfo;					//������� �Ҳ��ץ��ͼƬ�·��Ƿ���������ṹ����Ϣ�ַ�
...
typedef struct SDK_FaceKSDetectCfg
{
	bool bEnable;							//true:�����false:�ر�
	int nfps;//֡��
	char chSnapMode[NET_NAME_PASSWORD_LEN];	//ץͼģʽ��ȫץģʽ�͸�����ץ��ģʽ"FULL"/"QUILITY"
	char FLAGS64[256];			//BASE64 ����
	SDK_FaceKSPushStrategy fFacePushStrategy; //��ͼ���ԣ�������ͼģʽ�Ͷ�ʱ��ͼ
	SDK_FaceKSConstraint fConstraint;			//����������
	int nExposure;							//�����ع�ֵ[1,100]
	SDK_FaceKSInfoDisPlay fDisplay;			//����������Ϣ��ʾ
	bool bExpertEnable;						//�Ƿ���ר��ģʽ
	char CustomFPGA[1024];//fpga�Զ�������
	char resv[16];		//�����ֽ�
}SDK_FaceKSDetectCfg;
...
{
	int  isNeedCharge;         //ͣ���Ƿ��շ�
	int  fixedCarChargeCycle; //�̶����շ��������ͣ���ö��E_FIXCARD_CAR_CHARGE_CYCLE_TYPE
	int  fixedCarMoneyEveryCycle; //������ļƷ������£�һ�������ն���Ǯ�� ��λԪ
	int  tempCarFreeMinutes;  //���ͣ��ʱ������λ����
	int  tempCarChargeMostHour;  //�շ�ͣ�������ٸ�Сʱ�ⶥ
	int  tempCarMinutesFirstSec; //��ʼ�ƷѺ��׶γ��ȣ���λ����
	int  tempCarMoneyFirstSec;   //�׶����շѽ���λԪ
	int  tempCarMinutesEverySec; //�׶�֮���ÿ��ʱ������λ����
	int  tempCarMoneyEverySec;   //����ÿ���շѽ���λԪ
}SDK_LRPChargeRule;

//����������
enum SDK_E_LPR_LIGHT_WORKMODE
{
	LPR_LIGHT_KEEP_CLOSE,  //�ر�
	LPR_LIGHT_KEEP_OPEN,   //����
	LPR_LIGHT_AUTO_ADJUST, //���ݻ��������Զ�����
};

typedef struct SDK_LPRLigthControl
{
	char workMode;   //����ģʽ����ö�� SDK_E_LPR_LIGHT_WORKMOD
	char lighteness; //���ȣ��ڳ���ģʽ����Ч��0��ʾ�رղ���
	char resv[2];
}SDK_LPRLigthControl;
...
{
	E_LPR_RECOGNIZE_TRIGGER_BY_VIDEO,       //��Ƶ�Զ����
	E_LPR_RECOGNIZE_TRIGGER_BY_GROUND_COIL, //�ظ���Ȧ����
	E_LPR_RECOGNIZE_TRIGGER_BY_AUTO,		//��Ƶ+�ظ�
};

typedef struct SDK_LPRRecognizeTriggerMode
{
	char triggerMode;  //������ʽ����ö��E_LPR_RECOGNIZE_TRIGGERMODE
	char resv[3];
...
{
	E_LPR_TEMP_CAR_CHARGE_BY_TIME,         //��ʱ���շ�--��Ӧ�ṹ��-SDK_LPRChargeOnTimeRule
	E_LPR_TEMP_CAR_CHARGE_BY_TIMES,        //�������շ�--��Ӧ�ṹ��-SDK_LPRChargeOnTimesRule
	E_LPR_TEMP_CAR_CHARGE_BY_TIMESECTIONS, //��ʱ���շѣ���֧�ֶ��ʱ������ò�ͬ���շѱ�׼--��Ӧ�ṹ��-SDK_LPRChargeOnTimeSectionRule
...
typedef struct SDK_LPRChargeOnTimesRule
{
	...
	short usPayOne;/*һ���շѽ��*/
	short usFreeTime;/*���ʱ��*/
	short usFreeStartTime; /*��ѿ�ʼʱ�䣬�Է���Ϊ��λ*/
	short usFreeEndTime; /*��ѽ���ʱ�䣬�Է���Ϊ��λ*/
	short usPayStartTime; /*�շѿ�ʼʱ�䣬�Է���Ϊ��λ*/
	short usPayEndTime;/*�շѽ���ʱ�䣬�Է���Ϊ��λ*/
...
typedef struct SDK_LPRChargeOnTimeSectionRule
{
	...
	short usCycleTime;/* �Ʒ�����*/
	short usStartTime;/* ��ʱ��*/
	short usTotalPreDay;/* ʱ�ηⶥ���*/
	short usSectionStartTime; /*ʱ�ο�ʼʱ�䣬�Է���Ϊ��λ*/
	short usSectionEndTime;/*ʱ�ν���ʱ�䣬�Է���Ϊ��λ*/
}SDK_LPRChargeOnTimeSectionRule;

typedef struct SDK_LPRTempCarChargeRule
{
	char isCharge; //0:���շ�  1:�շ�
	char chargeMode; //�շ�ģʽ����ö��E_LPR_TEMP_CAR_CHARGE_MODE
...
{
	LPR_LED_MODE_TIME,		//ʱ����ʾ
	LPR_LED_MODE_VEH_LEFT,	//ʣ�೵λ��ʾ
	LPR_LED_MODE_PLATE_CODE,//������ʾ
	LPR_LED_MODE_WELCOME,	//��ӭ����ʾ
	LPR_LED_MODE_VEH_PAY,	//ͣ��������ʾ
	LPR_LED_MODE_VEH_TIME,	//ͣ��ʱ����ʾ
	LPR_LED_MODE_VEH_PERIOD,//������Ч����ʾ
	LPR_LED_MODE_CUSTOM,	//�û��Զ�����ʾ
...
{
	LPR_LED_COLOR_RED,		//��ɫ
	LPR_LED_COLOR_GREEN,	//��ɫ
	LPR_LED_COLOR_YELLOW,	//��ɫ
	LPR_LED_COLOR_MAX
};
...
typedef struct SDK_LprLedShowSet
{
	...
	char chInterVal;	//ʱ������룩
	char chLedLine;		//�к�
	char chMode;		//��ʾ����ģʽ--��enum SDK_LPR_LED_SHOW_MODE
	char pContent[LPR_MAX_LED_CONTENT];//�Զ���ģʽʱ��ʾ����
}SDK_LprLedShowSet;

typedef struct SDK_LprLedSet
{
	char chAudioEnable;	//����ʹ��
	char chReserverd[3];//�����ֶ�
	SDK_LprLedShowSet  stLedInIdle[LPR_MAX_LED_COUNT];//��ʱ�����ʾ������
	SDK_LprLedShowSet  stLedInBusy[LPR_MAX_LED_COUNT];//æʱ�����ʾ������
	SDK_LprLedShowSet  stLedOutIdle[LPR_MAX_LED_COUNT];//��ʱ������ʾ������
	SDK_LprLedShowSet  stLedOutBusy[LPR_MAX_LED_COUNT];//æʱ������ʾ������
}SDK_LprLedSet;
...
{
	LPR_LIST_OPT_ADD,//���ӳ���
	LPR_LIST_OPT_DELETE,//ɾ������
	LPR_LIST_OPT_UPDATE,//�޸ĳ�����Ϣ
	LPR_LIST_OPT_SEEK,//���ҳ�����Ϣ
	LPR_LIST_OPT_IMPORT,//��������ڰ�����
	LPR_LIST_OPT_EXPORT,//���������ڰ�����
...
{
	char pPlateCode[20];//���ƺ�
	char pStartTime[24];//��ʼʱ�� ��ʽ:2017-07-14
	char pEndTime[24];//��ֹʱ��
}SDK_LprBlackWhiteList;

enum SDK_LPR_BLACK_WHITE_LIST_WORK_MODE
{
	LPR_LIST_WORK_MODE_CLOSE,//������
	LPR_LIST_WORK_MODE_OFFLINE_WORK,//�ѻ�����
	LPR_LIST_WORK_MODE_ALWAYS_WORK,//�ѻ�����������
	LPR_LIST_WORK_MODE_ALL
};
enum SDK_LPR_BLACK_WHITE_LIST_MATCH_MODE
{
	LPR_LIST_MATCH_MODE_EXACT,//��ȷƥ��
	LPR_LIST_MATCH_MODE_IGNORE_CHINESE,//���Ժ���,���Ƚϳ����еĺ���
	LPR_LIST_MATCH_MODE_SIMILAR_CHAR,//�����ַ�ƥ�� 0-D 8-B O-Q E-F
	LPR_LIST_MATCH_MODE_PLAIN_CHAR,//��ͨ�ַ�ƥ��
	LPR_LIST_MATCH_MODE_ALL
};
struct SDK_LprBlackWhiteListMatchMode
{
	char chFuzzyMatchMode;//ģ��ƥ��ģʽ��LPR_BLACK_WHITE_LIST_MATCH_MODE
	char chValue;//��ͨ�ַ�ƥ��ģʽʱ�������ַ���ͬ�������
};
struct SDK_LprBlackWhiteListMode
{
	char chListType;//0 ������;1 ������
	char chWorkMode;//����ģʽ��ö�� LPR_BLACK_WHITE_LIST_WORK_MODE
...
{
	char chShowType;//0:��λ��1:���
	char chLineNo;//�к� 
	char chInterval;//ʱ����,��ʾ�೤ʱ��(��)
	int iValue;//��ʾ����ʾ���ݣ���ʾ��� ��ʣ�೵λ
};

//�����ʱ���շ��Զ�̧��
struct SDK_LprAutoContrlGate
{
	char chEntryEnable;//���̧��ʹ��
	char chExitEnable;//����̧��ʹ��
};
...
{
	char chEntryExit;		//���ø�����ǳ��������볡ʹ��
	char pEntryExitName[24];//���������
};

//�����շ�ϵͳͣ������Ϣ
struct SDK_LprParkingLotInfo
{
	char chParkingType;		//ͣ��������
	char pParkingName[64];	//ͣ��������
	char pPhoneNo[24];		//��ϵ�绰
	int iTotalParkingSpace; //�ܳ�λ
	int iUsedParkingSpace;  //��ͣ����
};

enum SDK_SendType
{
	LPR_CHARGE_RULE=1,	//�շѹ���--��struct SDK_LRPChargeRule
	LPR_CHARGE_MODE,	//�շ�ģʽ--��struct SDK_LPRTempCarChargeRule
	LPR_AUTO_CONTRL,	//�Զ�̧��--��struct SDK_LprAutoContrlGate
};

struct SDK_LprHttpCommunication
{
	char pServerAddr[24];		//��������ַ
	int iPort;					//�˿�
	int iTimeOut;				//��ʱʱ��
	char chPushResultEnable;	//�Ƿ�����ʶ����
	char pPushResultAddr[128];	//ʶ�������͵�ַ
	char chPushPicEnable;		//���ʹ�ͼƬʹ��
	char chPushSmallPicEnable;	//����СͼƬʹ��
};
...
{
	int  nChannel;			//ͨ��
	int  nDefenceType;		//��������--��ö��SDK_DEFENCE_TYPE
...
{
	char pautoupload[NAME_URL_LEN];//�Զ��ϴ���ַ
	char pvideoupload[NAME_URL_LEN];//��Ƶ�ϴ���ַ
	char pcameraupload[NAME_URL_LEN];//����ͷ�ϴ���ַ
	char ppincode[NAME_TOKEN_LEN];//PIN��
}SDK_CustomURLCfg;

enum SDK_MultiNet_Mode_Type
{
	MultiNet_Mode_SingleNetCard,		///< ������ģʽ
	MultiNet_Mode_LoadBalancing,		///< ���ؾ���ģʽ
	MultiNet_Mode_FaultTolerance,		///< �ݴ�ģʽ
	MultiNet_Mode_NR,
};

enum SDK_MultiNet_Route_Type 
{
	MultiNet_Route_eth0,				///< ����eth0 
	MultiNet_Route_eth1,				///< ����eth1 
	MultiNet_Route_NR,
};

enum SDK_MultiNet_Ability_Type 
{
	MultiNet_Ability_Normal,			///< ����ͨ�������豸����Ҫ���Խṹ��NetCommonConfigEx�ڵ�����
	MultiNet_Ability_Dual,				///< ��ʵ˫���� example:eth0+eth1
	MultiNet_Ability_VirtualDual,		///< ����˫���� example:eth0+eth0:1
	MultiNet_Ability_NR,
};
...
typedef struct SDK_NetCommonConfigEx
{
	...
	char					sMac[NET_MAX_MAC_LEN];	///< MAC��ַ
	int						BondMode;			///< ����ģʽ����ö��SDK_MultiNet_Mode_Type������֮�����������Ч��
	int						PriorityRoute;		///< ����·�ɣ���ö��SDK_MultiNet_Route_Type
	int						EthernetAbility;	///< ������������ö��SDK_MultiNet_Ability_Type(���ò�����)
	char					Reserved[120];		///< ����
...
{
	int MainStatus;				// 1��ʾ������; 2��ʾ������ 
	int iRectEnable[6];			// 1��ʾ����Ч; 2��ʾ����Ч
...
{
	char actionMode[10];	//ToAP:�л���APģʽ
	int channel;			//ͨ��ֵ�ķ�Χ[0-13]
}SDK_SWITCH_WIFI_MODE;

//���μ��
#define XM_IA_PD_NUM_MAX                (100)       /* ��������� */
#define XM_IA_PD_RULE_NUM_MAX           (4)         /* ���������㷨���������� */
...
typedef struct
{
	SDK_XM_IA_LINE_S stLine;                /* ����λ��X1,Y1Ϊ��ʼ��,X2,Y2Ϊ��ֹ��(�ٷֱȱ�ʾ0~8192��Ӧ0��100%) */
	int eAlarmDirect;						/* ˳��ʼ����ֹ�㷨�߷���Ϊ����,����ʼ����ֹ�㷨�߷���Ϊ���� */
...
{
	int iBoundaryPtsNum;					/* ��������� */
	SDK_XM_IA_POINT_S astBoundaryPts[8];    /* �������λ��(�ٷֱȱ�ʾ0~8192��Ӧ0��100%) */
	int eAlarmDirect;						/* �������Ϊ����,�뿪����Ϊ���� */
...
typedef struct
{
	SDK_XM_IA_RULE_LINE_S stRuleLine;       /* ���߹��� */
	SDK_XM_IA_RULE_REGION_S stRuleRegion;   /* �������� */
}SDK_XM_IA_PD_RULE_U;

/* ���й���ṹ�� */
typedef struct
{
	bool ucRuleEnable;						/* �����Ƿ�ʹ��:0��ʹ��/1ʹ�� */

	int eRuleType;							/* �������� */
	SDK_XM_IA_PD_RULE_U unPdRule;           /* ������� */

	unsigned int uiReserved[16];			/* �������:ʹ�� */
}SDK_XM_IA_PD_RULES_S;

/* �������μ���㷨������ṹ�� */
typedef struct
{
	SDK_XM_IA_PD_RULES_S stPdRules[XM_IA_PD_RULE_NUM_MAX];			/* ���μ����� */
	unsigned int uiReserved[3];										/* ������ֹ����� */
...
{
	bool bEnable;
	int iShowTrack;						//�Ƿ���ʾ�ټ�
	int iShowRule;						//�Ƿ���ʾ����
	int eSensitivity;					/* ���μ������� */
	int pedchoice;             /* ������0:��  0xFF:�������� */
...
{
	int iEncodeType;   //��������--SDK_AudioEncodeTypesĿǰֻ֧��SDK_AUDIO_ENCODE_G711_ALAW��SDK_AUDIO_ENCODE_G711_ULAW
...
//��Ⱥ��������DAS����Ⱥ��������ȡ����DAS������ip�Ͷ˿ں�
typedef struct SDK_DASMidSerInfo
{
	bool enable;//DAS�����Ƿ���
	bool MidEnable;//���ķ������Ƿ���Ч�������Ч�������ķ������ṩ��ip�Ͷ˿ںţ��������Ч�������õ�ֱ��ip�Ͷ˿ں�
	char serAddr[NET_NAME_PASSWORD_LEN];
	char resv[4];
}SDK_DASMidSerInfo;
...
{
	bool bHumanDection;				//���μ������
	bool bSupportAlarmLinkLight;	//�ƹ���ʾ����
	bool bSupportAlarmVoiceTips;	//������ʾ����
}SDK_HumanAbility;
...
typedef struct SDK_PgsDetectParam
{
	...
	int iDefaultP;// Ĭ�Ϻ��֣�����"��" ,����gb2312����
	int iPlateType;
	SDK_PgsRect stPgsRect[MAX_PLATE_NUM];//���������
	int iMaxWidth;//�����
	int iMinWidth;//��С����
	int iParkingLotNum;//����⳵λ��
}SDK_PgsDetectParam;
...
{
	int iUdpPort;	///< UDP�����˿�
	int iUdpDestPort;//UDPĿ�Ķ˿�
}SDK_PgsNccu;

enum SDK_E_PGS_SCENE
{
	SDK_E_PGS_PLANE_GARAGE,	//ƽ�泵��
	SDK_E_PGS_STEREO_GARAGE,//���峵��
};

typedef struct SDK_PgsLightCtrl
{
	int iCtrlOtherDVR;        //����DVRʹ��0:���Ʊ���DVR, 1:����Զ��DVR, 2:ͬʱ���Ʊ��غ�Զ��DVR
	char sIP[64];			  //����DVR IP
	char sUserName[64];		  //����DVR�û���
	char sPassword[64];		  //����DVR����
	int iOtherRegionNo;       //����DVR������
	int iOtherLightNum;       //����DVR�����Ӧָʾ�Ƹ���
	int iRegionNo;		      //���Ƶ�������
	int iLightNum;		      //���Ƶ������Ӧָʾ�Ƶĸ���
}SDK_PgsLightCtrl;

typedef struct SDK_PgsLightCtrlAll
{
	int iScene;		//Ӧ�ó���: �ο�ö�� E_PGS_SCENE
	int iStereoGaragePort;	//���峵��˿ں�
...
{
	char SplitMsk[NET_MAX_MSK_SIZE/2]; //ÿ��ģʽ��Ӧ�ķָ�ģʽ
	int	DigitalChnMax;		//�������ͨ����
	int	AnalogChnMax;		//���ģ��ͨ����
	int	TotalChnMax;			//�����ͨ����
}SDK_CustomModeAbilty;

typedef struct SDK_CustomModeAbiltyAll
{
	int nCustomMode;		//ʵ��֧�ֵ�ģʽ
	SDK_CustomModeAbilty CustomMode[MAX_HVR_CHNCAP_CHN];		//����ģʽ�Ļ���
...
{
	int iChannel;
	int cmdType;		//�������ͣ�0:Ĭ��ֵ����ʾʹ��NET_COAXIALCTRL_CMD ���1:��ʾ�����ַ�������
	int cmd;
	char strCmd[64];	//�ַ���������� FvideoCoaxialV2 �ӿ�
	int strCmdLen;
}SDK_CoaxialCtrlInfo;
...
{
	bool	bStorageMemory;//��־�洢���ڴ�ʹ��
	bool	bStorageFlash;//��־�洢��flashʹ��
}SDK_LogStorage;
...
{
	bool bEnable;
	int iMode;		// ���ͣ�1��group 0��bestface
	int iTime;
	bool bLevel;	//���ȼ�
	int iMatchRate;	//ƥ����
	SDK_EventHandler hEvent;
...
{
	bool		bEnable;			//������ʹ��
	char		sLeadScreenIP[64];		//������IP
	int			iLeadScreenPort;	//�������˿�
	int			iLeadScreenESN;		//�豸���	
}SDK_LeadScreenCfg;

typedef struct SDK_LeadScreen
{
	bool		bOutEnable;			//��λ���ʹ��
	int			iCarPortType[3];	//��λ���ͣ�0:��ͨ��λ,1:ר�ó�λ
	int			iCarPortOut[3];		//��λ�������,0:��ֹ���,1:�������
	SDK_LeadScreenCfg stLeadScreenCfg[5];//���������� 
}SDK_LeadScreen;

//��ά������LightEnable[0]���õƣ�LightEnable[1]���õ�1��LightEnable[2]���õ�2����LightEnable[3]���õ�3
//��ά�����1�н��ܿ��ƣ���2�г�λ1����3�г�λ2����4�г�λ3
...
typedef struct{
	...
	double latitude;			//GPSγ��
	char Supplier[256];			//��Ӧ������
	char APN[256];				//APN����
	char SIMCARDNo[32];			//��������
	unsigned int RSSI;			//�ź�ǿ��
	char IPADDR[24];			//IP��ַ
	unsigned int MonConsum;		//��������
	char SIMStatus[256];		//������״̬
}SDK_XM_firm_sim_info_t;
	
typedef struct{
	char Code[256];				//��Դ�豸��ַ����
	char Name[256];				//��Դ�豸����
	char SolarPanelStatus[256];	//̫���ܰ�״̬
	double PVArrayVoltage;		//������е�ѹ
	double PVArrayCurrent;		//������е�Դ
	double BatteryVoltage;		//���ص�ѹ
	double BatteryCurrent;		//���ص���
	double DeviceVoltage;		//���ص�ѹ
	double DeviceCurrent;		//���ص���
	double BatteryLevel;		//���ʣ�����
	double BatteryTemp;			//����¶�
	bool BatteryOn;				//��س���
...
typedef struct{
	char ServerID[64];				////ƽ̨����
	char ServerIP[24];				//ƽ̨IP
	int  ServerPort;				//ƽ̨�˿ں�
	char DeviceID[64];				//�豸����
	char DeviceIP[24];				//�豸IP
	char ChannelID[32][64];			//ǰ���豸֧�ֵ�ͨ����Ϣ
	char DevicePassword[64];		//�豸������
	int ActChannelNum;				//ʵ��ͨ������
	int EnableB;					//�Ƿ�ʹ��B�ӿ� 1:ʹ�� 0:�ر�
...
/*
	...
	3.����ͼƬ��������----nType=PUSH_TYPE
	4.ͨ������ͼƬ��������----nType=PUSH_TYPE_NORMAL_FACE	
*/
...
/*
	nResult = 1��ʾ�������
	nResult = 2��ʾ�����豸����ʧ��---�������nError(101:δ֪����;109������ʧ�ܣ�û���ҵ���Ӧ�ļ�;603:��Ҫ�����豸����Ч)
			ע��NVR�豸����nError=0����ͨ��pErrorInfo��ȡ��������ͨ��
	nResult = 3��ʾ���͹����г���
*/
...
/*
	...
	����:
		...
		sPassword[in]:    ����
		lpDeviceInfo[out]:�����豸��Ϣ
		nType[in]:		  ��½���ͣ���enum SDK_LoginType��һ�㴫0��
		sPwdHead[in]:	  ����ǰ׺��һ�㶨��ʹ�ã�	
		error[out]:		  ���ص�½������
		socketType[in]:	  ��½��ʽ
	����ֵ:
		>0:	   �ɹ�
...
/*
	...
	����:
		lLoginID[in]:��½���
		type[in]:	 ��������,0 �����豸��1 �����־ 2 �ػ� 3.�ָ���¼��־ 4.ֹͣ��¼��־ 5.����¼��־���ڴ棬������flash
		waittime[in]:�ȴ�ʱ��
	����ֵ:
		true: �ɹ�
		false:ʧ��
...
/*
	...
	ntype[in]:			 0-�������汾��Ϣ;
						 1-���������汾��Ϣ
	lpOutBuffer[out]:    �豸�汾����Ϣ:
						 ���߶�Ӧ�Ľṹ��SDK_CloudUpgradeVersionRep;
						 ���ض�Ӧ�Ľṹ��H264_DVR_DEVICEINFO
	dwOutBufferSize[out]:�豸�汾��Ϣ�Ĵ�С
	lpBytesReturned[out]:���յ��Ĵ�С
	waittime���ȴ�ʱ��
	����ֵ:
	=0:�ɹ�
	<0:ʧ��
	��غ�����H264_DVR_Upgrade_CloudEX
*/
...
/*
		...
		pBuffer[out]:			ͼƬ����
		nBuflen[out]:			ͼƬ��С
		AllPicNumber[out]:		���ص�ͼƬ��--����������ڲ�ѯ��Χ��Ϊ�����������������ڲ�ѯ��Ϊʵ����
*/
...
/*
	...
	����:
	lLoginID[in]:	��½���
	dwCommand[in]:	��������--��enum SDK_LPR_LIST_OPT_TYPE
	dwtype[in]:		��������--��enum SDK_LPR_LIST_TYPE
	lpBuffer[]:		����--��--SDK_LprBlackWhiteList
	dwBufferSize[]:	���ݸ���--���������Ľṹ�����
	szfileName[]:	�ļ�������������ʱ����������ȡ�����Ϊ��ʱ������
	waittime[in]:   �ȴ�ʱ�� 
	����ֵ:
	=1:�ɹ�
	<0:ʧ��
...
/*
	...
	����:
		...
		MsgID[in]:			 ��ϢID--1042
		nChannelNO[in]:		 ͨ����,-1:�õ�ȫͨ������,0-n:�õ�����ͨ��������,��0��ʼ
		lpInBuffer[in]:		 �����json�ַ���
		lpInBufferlen[in]:	 �����json�ַ�����С
		lpOutBuffer[out]:	 ����json����
		dwOutBufferSize[in]: ���ջ����С
		lpBytesReturned[out]:�õ��Ļ����С(�ֽ�)
		waittime[in]:		 �ȴ�ʱ��
...
/*
	...
	����:
		sDVRIP[in]:			��Ҫ���õ��豸IP
		wDVRPort[in]:		��Ҫ���õ��豸�˿ںţ�һ��Ϊ34567��
		strName[in]:		json��
		lpOutBuffer[out]:	���ջ���----�����豸���ص�ʵ�ʽ��������
		dwOutBufferSize[in]:���ջ���Ĵ�С
		lpBytesReturned[out]:ʵ�ʷ��صĴ�С
		socketType[in]:		��������------TCP��0
	����ֵ:
		true: �ɹ�
		false:ʧ��
